...
import { GameKnowledgeHub } from './components/GameKnowledgeHub';
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const handleRouteChange = () => {
      ...
      else if (path === '/community' || path === '/expert-qa' || path === '/coaching') setCurrentPage('community');
  ...
  if (currentPage === 'community') return <GameKnowledgeHub />;
